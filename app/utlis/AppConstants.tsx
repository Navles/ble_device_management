...
export default {
  ...
  colors: {
    ...
    secondary: Theme.colors.textPrimary, // Mapping old secondary (text) to textPrimary
    white: Theme.colors.white,
    background: Theme.colors.background,
    error: Theme.colors.error,
    success: Theme.colors.success,
    warning: Theme.colors.warning,
    tableHeader: Theme.colors.tableHeader,

    // New Theme mappings exposed for backward compatibility or direct use
    highlight: Theme.colors.highlight,
    accent: Theme.colors.secondary, // The new secondary color (purple-ish)
